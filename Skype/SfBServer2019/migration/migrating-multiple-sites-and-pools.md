...
2. After deploying a Microsoft Edge Server in the pilot pool, you need to validate that external users can communicate with the Skype for Business Server 2019 pool.
...
4. After transitioning the federated routes' Microsoft Edge Servers to the pilot Skype for Business Server 2019 Microsoft Edge Servers, you need to validate that federated users can communicate with the Skype for Business Server 2019 pool.
    
5. After moving all users and nonuser contact objects, you need to validate that the legacy pool is empty.
