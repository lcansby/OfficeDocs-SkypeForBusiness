...
Effective October 14, 2025, the Microsoft Teams Rooms app based on classic Teams will no longer be accessible on Teams Rooms on Windows (version 4.19 or older), Surface Hub v1, and Surface Hub 2S devices running Windows 10 Team edition. This change aligns with the previously announced [retirement of the Teams classic client](/microsoftteams/teams-classic-client-end-of-availability) and the [end of support for Windows 10](/lifecycle/products/windows-10-team-surface-hub). After this date, users will not be able to use the Teams app on these devices.   
