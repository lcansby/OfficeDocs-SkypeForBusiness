---
title:  New Teams desktop client features not available in the web client
...
# Features currently unavailable in new Teams for Web

Not all features available in new Microsoft Teams desktop clients are available on new Teams for Web. Here are the primary features currently unavailable on the web client.

|Category|Feature Name|Details|Link|
|:-----|:-----|:-----|:-----|
|Early Access|Public Preview|Public Preview is unavailable on Microsoft Teams on the web. Only users assigned to the *Microsoft 365 Targeted release* will see preview features on Microsoft Teams on the web|[Details](public-preview-doc-updates.md?tabs=new-teams-client)|
...
|Meetings and Calls|High fidelity music mode||[Details](https://support.microsoft.com/office/use-high-fidelity-music-mode-to-play-music-in-microsoft-teams-c1550582-2f76-4b31-9f72-e98c7167a18e)|
|Meetings and Calls|Create and manage breakout rooms||[Details](https://support.microsoft.com/office/use-breakout-rooms-in-microsoft-teams-meetings-7de1f48a-da07-466c-a5ab-4ebace28e461)|
