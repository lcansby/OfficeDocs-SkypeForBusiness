...
## Microsoft Teams App End of Availability on Teams Rooms on Windows 10, Surface Hub v1, and Surface Hub 2S Running Windows 10 Team Edition

Effective October 14, 2025, the Microsoft Teams app will no longer be accessible on Teams Rooms on Windows 10, Surface Hub v1, and Surface Hub 2S devices running Windows 10 Team edition. This change aligns with the previously announced [retirement of the Teams classic client](/microsoftteams/teams-classic-client-end-of-availability) and the [end of support for Windows 10](/lifecycle/products/windows-10-team-surface-hub). After this date, users will not be able to use the Teams app on these devices.   
