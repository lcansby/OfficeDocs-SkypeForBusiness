...
description: "The UserAgent View stores information about the user agents that are involved in sessions that have records in the database. This view was introduced in Microsoft Lync Server 2013."
---
...
|UAType  <br/> |smallint  <br/> |Type of user agent. For more information, see the [UserAgent table](useragent.md). <br/> |
