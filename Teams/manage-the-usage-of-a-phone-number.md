...
1. On the **Phone numbers** page, choose an unassigned number in the list, and then select **Change usage**.
   ...
   - Make sure you have more types of usage in the **Available usages** column than in the **Licensed usages** column. Otherwise, number usage change option is not applicable.
