...
For more information on certified devices and infrastructure, contact partners listed at [Infrastructure qualified for Lync](../../../SfbPartnerCertification/lync-cert/qualified-ip-pbx-gateway.md).