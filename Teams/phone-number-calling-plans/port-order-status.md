...
|Manual review |Your order is in review with Microsoft’s support team. |You can edit the order name, extra contacts, and number usage. |Microsoft's Support team will contact you if any other information is needed. |
