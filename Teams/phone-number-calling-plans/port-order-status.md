...
|Not submitted |Your order is validated and ready to be signed and submitted. |You can edit or delete your order. |You can edit and revalidate the order. </br>In this status, you need to sign and submit your LOA in one of two ways in the port wizard: </br>1. Upload a signed LOA (available in all supported markets), </br>Request an E-signature submission (US & CA only currently). |
|Manual review |Your order is in review with Microsoft’s support team. |You can edit the order name, extra contacts, and number usage. |Support team contacts you if any other information is needed. |
