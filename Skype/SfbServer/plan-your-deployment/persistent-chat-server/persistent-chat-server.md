...
- For details about migrating Persistent Chat pool from Skype for Business Server 2015 to Skype for Business Server 2019 see, [Migrate Persistent Chat Pool](../../../SfBServer2019/migration/migrate-persistent-chat-pool.md).
