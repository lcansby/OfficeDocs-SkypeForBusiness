...
As you navigate through the **Define New Edge Pool** wizard, review the key configuration settings shown in the following steps. Only a few pages of the **Define New Edge Pool** wizard are shown. 
