...
A "unique" organizer is anyone who schedules at least one conference. For example, if Pilar Ackerman schedules one conference, it counts as one unique organizer. If Ken Myer schedules 148 conferences, it too counts as one unique organizer. For example, the following table shows eight conferences scheduled, but just three unique organizers (Ken Myer, Pilar Ackerman, and David Ahs).
...
Total values for most of the metrics used on the Conference Summary Report can be found at the bottom of the report; scroll down to see values such as the total number of conferences held during the specified time period, and the total number of people who participated in those conferences. One metric that isn't totaled at the bottom of the report is Total unique conference organizers. Why not? Here's one reason. Suppose you're looking at a month's worth of data. On day 1 you had 34 unique conference organizers; on day 2 you had 27 unique conference organizers. Does that mean you had 61 unique conference organizers for those two days? Not necessarily. After all, all 27 people who organized conferences on day 2 might be among the 34 people who organized conferences on day 1. For example, in this simple report Ken Myer and Pilar Ackerman scheduled conferences both on 7/7/2015 and on 7/2/2015:
...
|:-----|:-----|:-----|
|**Hourly** <br/> **Daily** <br/> **Weekly** <br/> **Monthly** <br/> |No  <br/> |Indicates the time interval that you selected on the filter toolbar. Where applicable, you can select a given time interval to view detailed information for that interval. For example, if you're using the Daily interval and you select 7/7/2015, you see an hourly breakdown of user registration activity for that date.  <br/> |
|**Total conferences** <br/> |No  <br/> |Total number of conferences (regardless of conference type) that were held. When you select this item, the report shows you the Conference Activity Report for the selected time period.  <br/> |
|**Total participants** <br/> |No  <br/> |Total number of people who took part in the conferences. When you select this item, the report shows you the Conference Activity Report for the selected time period.  <br/> |
...
|**Total A/V conference participant minutes** <br/> |No  <br/> |Total number of participant minutes devoted to audio/video conferencing. For example, suppose one user spends 5 minutes in an audio/video conference and a second user spends 3 minutes in that same conference. That makes a total of eight participant minutes: 5 minutes plus 3 minutes.  <br/> |
