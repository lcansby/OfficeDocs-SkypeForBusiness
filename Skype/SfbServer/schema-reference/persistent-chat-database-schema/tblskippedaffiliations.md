...
description: "tblSkippedAffiliations contain the affiliations that couldn't be read (due to Active Directory Domain Services access errors)."
---
...
|updatedBy  <br/> |int, not null  <br/> |ID of the principal that updated this row. It's always 1 (system user) because Active Directory Sync is the only source for these entries.  <br/> |
