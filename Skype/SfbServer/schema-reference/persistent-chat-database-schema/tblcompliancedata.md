...
description: "tblComplianceData contains the compliance events that haven't been processed by the compliance adapter yet."
---
...
|entryDate  <br/> |smalldatetime, not null  <br/> |Time of insertion (might be far in the future for cmplType=9 because the entry is just a placeholder in that case).  <br/> |
