...
- **Edit Properties**. Opens the **Edit Properties** page for this Survivable Branch Appliance, where you can change the FQDN (if the topology isn't already published), the associations, and resiliency settings.
