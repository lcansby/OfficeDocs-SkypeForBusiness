...
> [!NOTE]
> For more information about classic Teams on Surface Hub v1 and Surface Hub 2S devices running Windows 10 Team edition, please check the [Teams Rooms lifecycle support documentation](/microsoftteams/rooms/rooms-lifecycle-support) for the latest information.
