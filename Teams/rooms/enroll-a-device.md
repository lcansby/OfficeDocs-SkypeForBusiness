...
For Teams Rooms on Windows devices, the Teams Rooms Pro Management agent will be automatically downloaded and installed at device setup. For Teams Rooms on Android devices or Teams panels, the admin agent included on the device will automatically connect to the Pro Management Portal. Devices once signed into Teams will automatically enroll and appear in the Teams Rooms Pro Management Portal. 
...
Ensure the required URLs listed in [Teams Rooms - Network Security](security.md?tabs=Windows#network-security) are allowed on your network.
...
### If required, configure proxy settings on the device
...
1. The room will appear in the portal within 5-10 minutes.
...
Ensure the required URLs listed in [Teams Rooms - Network Security](security.md?tabs=Windows#network-security) are allowed on your network. Along with these two additional URLs:
...
1. Sign in to the Microsoft Intune.
1. Select **Apps** > **All apps** > **Add**.
1. In the **Select app type** pane, under **Other** app types, select **Line-of-business app**.
1. Click **Select**. The **Add app** steps are displayed. 
1. In the **Add app** pane, click **Select app package file**.
...
1. This command resets the device to user standard Teams Rooms updates and removes the Teams Rooms Pro management monitoring agent and files.
1. From the left-hand menu in the Microsoft Teams Rooms Pro Management portal, select **Rooms**.
1. In the list of rooms provided, choose the room you want to unenroll and select **Remove** to stop getting incident alerts or investigation tickets, or to report an incident for the room.
