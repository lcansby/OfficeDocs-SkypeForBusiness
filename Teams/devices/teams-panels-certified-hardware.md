...
| Device model | Latest firmware version | Minimum firmware version | Included Microsoft applications | Release date |
|:----------------|:-------------------|:----------------------------|:-------------------------------------------------------------------------|:-------------------------------------|
| Neat Pad | `NFA1.20250402.2006` | N/A| Teams client: `1449/1.0.97.2025086303` <br> Microsoft Intune: `25.02.1` <br> Authenticator: `6.2505.3166` <br> Admin Agent: `1.0.0.202505080136.product (784)`| June 17, 2025|
